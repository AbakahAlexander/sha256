...
class CryptoGuardian:
    ...
    def get_status(self):
        ...
        return {
            ...
            "recent_anomaly_score": self.metrics_history[-1]["anomaly_score"] if self.metrics_history else 0,
            "recent_threat": self.metrics_history[-1]["threat_type"] if self.metrics_history else "None"
        }
